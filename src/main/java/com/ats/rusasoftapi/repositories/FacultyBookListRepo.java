...
public interface FacultyBookListRepo extends JpaRepository<FacultyBookList, Integer> {
	...
	List<FacultyBookList> getJouByYear(int yearId, int instituteId);
	...
	List<FacultyBookList> getJournalByDept(List<Integer> deptIdList, int yearId, int instituteId);
	...
	List<FacultyBookList> getJournalRepo(int facultyId, int yearId, int instituteId);

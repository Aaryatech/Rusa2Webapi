...
public class DashBoardCounts {
	...
	public String toString() {
		return "DashBoardCounts [totalfaculties=" + totalfaculties + ", totalfacultieswithPHD=" + totalfacultieswithPHD
				+ ", ratio=" + ratio + ", totalstudent=" + totalstudent + ", noofprogram=" + noofprogram
				+ ", noOfreserchpub=" + noOfreserchpub + ", noofbookpub=" + noofbookpub + ", currfinyearbudget="
				+ currfinyearbudget + ", researchprojecttitle=" + researchprojecttitle + ", noofpatentsfilled="
				+ noofpatentsfilled + ", libraryusageperdayfaculty=" + libraryusageperdayfaculty
				+ ", libraryusageperdaystudents=" + libraryusageperdaystudents + ", noofbooksinlibrary="
				+ noofbooksinlibrary + ", LMSsoftwarename=" + LMSsoftwarename + ", noofLMSsoftwareusers="
				+ noofLMSsoftwareusers + ", totalresearchprojects=" + totalresearchprojects + ", totalnoofMOUs="
				+ totalnoofMOUs + ", totallinkages=" + totallinkages + ", fundingfrom=" + fundingfrom
				+ ", getTotalfaculties()=" + getTotalfaculties() + ", getTotalfacultieswithPHD()="
				...
				+ getTotallinkages() + ", getFundingfrom()=" + getFundingfrom() + ", getClass()=" + getClass()

...
public interface GetPhysicalFacilityBudgetRepo extends JpaRepository<GetPhysicalFacilityBudget, Integer> {
	...
	@Query(value = " SELECT t_physical_facility_budget.physical_facility_budget_id,t_physical_facility_budget.fin_year_id,t_physical_facility_budget.institute_id,t_physical_facility_budget.ac_year_id,\n"

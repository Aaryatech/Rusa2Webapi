...
public interface GetUserDataRepo extends JpaRepository<GetUserDetail, Integer>
{
    ...
    @Query(value=" SELECT i.faculty_id as user_detail_id,i.	faculty_name as sub_user_name,i.contact_no as user_con_number,"
    ...
    @Query(value=" SELECT i.librarian_id as user_detail_id,i.librarian_nameas sub_user_name,i.contact_no as user_con_number,"

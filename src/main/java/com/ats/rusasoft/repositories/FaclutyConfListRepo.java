...
public interface FaclutyConfListRepo extends JpaRepository<FacultyConferenceList, Integer> {
	...
	List<FacultyConferenceList> getJouByYear(int yearId, int instituteId);
	...
	public List<FacultyConferenceList> getJournalByDept(List<Integer> deptIdList, int yearId, int instituteId);
	...
	public List<FacultyConferenceList> getJournalRepo(int facultyId, int yearId, int instituteId);	

...
public interface FacultiContriRepo extends JpaRepository<FacultiContributionList, Integer> {
	...
	List<FacultiContributionList> getJouByYear(int yearId, int instituteId);
	...
	List<FacultiContributionList> getJournalByDept(List<Integer> deptIdList, int yearId, int instituteId);
	...
	List<FacultiContributionList> getJournalRepo(int facultyId, int yearId, int instituteId);
